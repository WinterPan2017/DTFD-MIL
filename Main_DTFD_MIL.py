...
def main():
    ...
    # unified dataset
    SlideNames_train, FeatList_train, Label_train = get_data("train", params.csv_path, params.feature_dir, params.fold, params.nfolds)
    SlideNames_val, FeatList_val, Label_val = get_data("val", params.csv_path, params.feature_dir, params.fold, params.nfolds)
